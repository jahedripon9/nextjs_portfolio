        ...
        <div className='mt-20'>
            ...
            <div className='text-center sm:flex items-center justify-between border-t border-gray-300 mx-[10%] mt-12 py-6'>
                ...
                <ul className='flex items-center gap-10 justify-center mt-4 sm:mt-0'>
                    <li><a target='_blank' href="https://github.com/jahedripon9">GitHub</a></li>
                    <li><a target='_blank' href="https://www.linkedin.com/in/jahedripon9/">Linkedin</a></li>
                </ul>
            </div>
        </div>
    )
